          ...
          <div className="flex gap-1 p-1 bg-gray-100 rounded-lg">
            {searchTabs.map((tab) => (
              <button
                ...
                className={`px-8 py-3 rounded-md font-medium text-sm transition-all min-w-[100px] ${
                  activeTab === tab.value
        ...
        <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 items-end">
            ...
            <div className="flex gap-3 lg:col-span-1 col-span-1 sm:col-span-2 md:col-span-3">
              ...
              <Button 
                color="outline" 
                className="flex items-center justify-center gap-2 px-4 py-3 border-[var(--color-secondary-300)] text-[var(--color-secondary-600)] hover:bg-[var(--color-secondary-50)]"
              >
